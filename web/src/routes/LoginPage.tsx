...
export function LoginPage() {
	...
	return (
		<div className="max-w-md mx-auto">
			<h1 className="text-2xl font-semibold mb-4 dark:text-gray-100">Login</h1>
			<form onSubmit={onSubmit} className="space-y-3">
				...
				<button disabled={loading} className="w-full bg-blue-600 text-white rounded px-3 py-2 disabled:opacity-50 hover:bg-blue-700">{loading ? 'Signing in...' : 'Login'}</button>
			</form>
			<p className="text-sm mt-3 dark:text-gray-300">No account? <Link to="/register" className="text-blue-600 dark:text-blue-400">Register</Link></p>
		</div>
	);
}
